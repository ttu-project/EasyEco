...
export const getForecast = (getUsage, dailyRecords = [], monthlyBudget = 0) => {
  ...
  // Determine baseline for Day 1
  // If we have submitted records, the first record's rate backfills earlier days (Rule 4).
  // Otherwise, live daily units acts as the baseline.
